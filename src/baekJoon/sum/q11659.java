...
public class q11659 {
    ...
    public static int sumInRange(int[] sumNumbers, int start, int end){
        if(start == 1) {
            return sumNumbers[end-1];
        }

        return sumNumbers[end-1] - sumNumbers[start-2];
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<caseCount; i++) {
            ...
            results[i] = sumInRange(sumNumbers, start, end);
        }
